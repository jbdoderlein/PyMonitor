...
class ClassLoader:
    ...
    def get_class(self, class_name: str, module_path: str) -> type | None:
...
class CodeManager:
    ...
    def store_class(self, cls: type) -> str | None:
    ...
    def get_code(self, code_ref: str) -> dict[str, Any] | None:
    ...
    def get_object_code(self, object_ref: str) -> dict[str, Any] | None:
