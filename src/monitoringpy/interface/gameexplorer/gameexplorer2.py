...
class GameExplorer:
    ...
    def _regenerate_image_from_drawing_calls(self, session_id: int, call_index: int) -> Optional[str]:
    ...
    def _surface_to_base64(self, surface: pygame.Surface) -> Optional[str]:
    ...
    def _decode_image(self, image_data: str, transparency_image_data: Optional[str] = None, stroboscopic_image_data_list: Optional[List[str]] = None) -> Optional[ImageTk.PhotoImage]:
