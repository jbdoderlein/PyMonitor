...
class ReexecutionnerClient:
    ...
    def reanimate(self, call_id: Union[str, int], ignore_globals: Optional[List[str]] = None, 
    ...
    def replay(self, call_id: Union[str, int], ignore_globals: Optional[List[str]] = None) -> Dict[str, Any]:
        """
