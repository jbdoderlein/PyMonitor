...
@monitoringpy.pymonitor(ignore=['SCREEN', 'FONT', 'clock'], return_hooks=[pygame.capture_buffered_pygame_events])
def display_game():
...
if __name__ == "__main__":
    ...
    monitoringpy.PyMonitoring.get_instance().export_db("instrumented.db")
    pygame.quit()
